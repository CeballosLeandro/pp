        ...
        <div class="row justify-content-center mt-5">
            <div class="col-md-6">
                ...
                <div class="d-flex justify-content-center mt-4">
                    <a href="login-modules/login.php" class="btn btn-primary mr-3 m-4 bi bi-door-open-fill" style="font-size: 2rem;"></a>
                    <a href="login-modules/registro.php" class="btn btn-success m-4 bi bi-box-arrow-in-right" style="font-size: 2rem;"></a>
                    <a href="crud-modules/forms/guest.php" class="btn btn-warning m-4 bi bi-person-video3 text-white" style="font-size: 2rem;"></a>
                </div>
            </div>
        </div>
    </div>
